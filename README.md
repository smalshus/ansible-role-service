...
- name: Converge
  ...
  vars:
    _service_test_command:
      ...
      Ubuntu-16: /bin/sleep
      Ubuntu-18: /bin/sleep
    service_test_command: "{{ _service_test_command[ansible_facts['distribution'] ~ '-' ~ ansible_facts['distribution_major_version']] | default(_service_test_command[ansible_facts['os_family']] | default(_service_test_command['default'])) }}"  # noqa 204 Just long.
